...
const PenthouseParisianBook = () => {
    ...
    useEffect(() => {
        const fetchPriceData = async () => {
            try {
                const response = await fetch(`https://api.aizahhospitality.com/api/priceView/68d7bc1c7d587ef507226612`);
                if (!response.ok) {
    ...
    const handleBookNow = async () => {
        ...
        const roomname = "Penthouse Parisian";
...
export default PenthouseParisianBook;