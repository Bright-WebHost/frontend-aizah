...
import RevaBook from '@/components/RevaBook/RevaBook'
                    ...
                    <div className="container">
                        <div className="flex max-lg:flex-col-reverse gap-y-10 justify-between">
                            ...
                            <div className="review-block lg:mt-10 mt-6 lg:pt-10 pt-6 border-t border-outline">
                                  ...
                                  <div className="list-review lg:pt-4 pt-2">
  {testimonialData.slice(4, 6).map((item, index) => (
      ...
      <div className="w-full lg:pr-[15px]">
        ...
        <div className="relative">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3455.318248786363!2d55.2832407!3d25.1878708!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f683ac1968601%3A0x69e5b1840395e8de!2sDAMAC%20-%20Reva%20Residences!5e1!3m2!1sen!2sin!4v1753681695352!5m2!1sen!2sin"
            allowFullScreen
            loading="lazy"
